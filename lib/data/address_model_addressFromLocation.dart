...
class address_model_addressFromLocation {
  address_model_addressFromLocation({
      Input? input, 
      List<Result>? result,}){
    _input = input;
    _result = result;
  ...
  address_model_addressFromLocation.fromJson(dynamic json) {
  ...
  Input? _input;
  List<Result>? _result;
address_model_addressFromLocation copyWith({  Input? input,
  List<Result>? result,
}) => address_model_addressFromLocation(  input: input ?? _input,
